...
public class NoticeList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.setAttribute("subTitleNum", 4);
	      ...
	      ArrayList<NoticeDTO> list = dao.list(isSearch,map);
	      ...
	      if (n == 1) {
	         ...
	         pagebar += String.format("<a href='/CDSInfo/noticelist.do?subTitleName=고객센터&page=%d'> <img src=\"images/ico_prev.png\"></a>", n-1);
	      }
	      ...
	      while (!(loop > blockSize || n > totalPage)) {
	         ...
	         if (n == nowPage) {
	            ...
	            pagebar += String.format(" <span><a href='/CDSInfo/noticelist.do?subTitleName=고객센터&page=%d'>%d</a></span> ", n, n);
	         }
	      ...
	      if (n > totalPage) {      
	         ...
	         pagebar += String.format("<a href='/CDSInfo/noticelist.do?subTitleName=고객센터&page=%d' aria-label='Next'> <img src=\"images/ico_next.png\"></a>", n);
	      }
