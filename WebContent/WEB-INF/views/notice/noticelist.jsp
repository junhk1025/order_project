...
<style>
	...
	#content-notice-nav > span:first-child > a{
		color: black;
   		font-weight: bold;
	}
	...
	<div class="section02" id="content-notice">
		...
		<div id="content-notice-navbox">
			...
			<div id="content-notice-search">
				<form method="GET" action="noticelist.do" id="form">
			...
			<tbody>
				...
				<c:forEach items="${list}" var="dto">
					<tr>
						<td>${dto.rnum}</td>
						<td>
							<a href="/CDSInfo/view.do?subTitleName=고객센터&seq=${dto.seq}">${dto.subject}</a>
		...
		${pagebar}
		<c:if test="${lv == 1}">
		<div id="write-button" onclick="location.href='/CDSInfo/noticewrite.do?subTitleName=고객센터'">글쓰기</div>
		</c:if>
	</div>
