...
<style>
	...
	#content-notice-nav > span:nth-child(1) > a{
		color: black;
   		font-weight: bold;
	}
...
<body>
   ...
   <div class="section02" id="content-qna">
      ...
      <div id="view-button-box">
      	<c:if test="${lv == 1}">
	    	<div class="view-button" onclick="location.href='noticeedit.do?subTitleName=고객센터&seq=${result.seq}';">수정</div>
	     	<div class="view-button" id="btn-confirm">삭제</div>
	     </c:if>
	      <div class="view-button" onclick="location.href='noticelist.do?subTitleName=고객센터';">목록</div>
      </div>
   </div>
   ...
   var modalConfirm = function(callback){
	 ...
	 modalConfirm(function(confirm){
	   if(confirm){
	     ...
	     location.href='noticedeleteok.do?seq=${result.seq}';
	   }
	 });
   </script>
</body>
